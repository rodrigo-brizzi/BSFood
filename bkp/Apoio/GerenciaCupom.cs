    ...
    public class GerenciaCupom  : IDisposable
    {
        ...
        public void AbreRelatorio(bool blnImprimeCabecalho = true)
        {
            ...
            if (blnImprimeCabecalho)
            {
                ...
                this.arrRelatorio.Add(Util.objConfigStorage.objEmpresa.emp_nomeFantasia);
                this.arrRelatorio.Add(Util.objConfigStorage.objEmpresa.emp_logradouro + "," + Util.objConfigStorage.objEmpresa.emp_numero + "-" + Util.objConfigStorage.objEmpresa.emp_bairro);
                this.arrRelatorio.Add("Fone: " + Util.objConfigStorage.objEmpresa.emp_telefone + (string.IsNullOrWhiteSpace(Util.objConfigStorage.objEmpresa.emp_fax) ? "" : ", " + Util.objConfigStorage.objEmpresa.emp_fax));
                this.arrRelatorio.Add("=======================================");
                this.arrRelatorio.Add(" ");
            }
        }
        ...
        {
            this.arrRelatorio.Add(Util.RetiraCaracterEspecial(strLinha));
        }
