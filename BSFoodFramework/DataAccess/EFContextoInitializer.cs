...
namespace BSFoodFramework.DataAccess
{
    public class EFContextoInitializer : IDatabaseInitializer<EFContexto>
    {
        ...
        public void CargaInicial(EFContexto objCtx)
        {
            ...
            objCtx.tbFormaPagamentoTipo.Add(new tbFormaPagamentoTipo { fpt_descricao = "DINHEIRO", fpt_cobranca = "V", fpt_codigoSat = "1" });
            objCtx.tbFormaPagamentoTipo.Add(new tbFormaPagamentoTipo { fpt_descricao = "CHEQUE A VISTA", fpt_cobranca = "V", fpt_codigoSat = "2" });
            objCtx.tbFormaPagamentoTipo.Add(new tbFormaPagamentoTipo { fpt_descricao = "CHEQUE A PRAZO", fpt_cobranca = "P", fpt_codigoSat = "2" });
            objCtx.tbFormaPagamentoTipo.Add(new tbFormaPagamentoTipo { fpt_descricao = "BOLETO", fpt_cobranca = "P", fpt_codigoSat = "99" });
            objCtx.tbFormaPagamentoTipo.Add(new tbFormaPagamentoTipo { fpt_descricao = "CARTAO DEBITO", fpt_cobranca = "V", fpt_codigoSat = "4" });
            objCtx.tbFormaPagamentoTipo.Add(new tbFormaPagamentoTipo { fpt_descricao = "CARTAO CREDITO", fpt_cobranca = "V", fpt_codigoSat = "3" });
            objCtx.tbFormaPagamentoTipo.Add(new tbFormaPagamentoTipo { fpt_descricao = "CONVENIO", fpt_cobranca = "P", fpt_codigoSat = "5" });
            ...
            //Formas de pagamento
            objCtx.tbFormaPagamento.Add(new tbFormaPagamento { fpg_descricao = "DINHEIRO", fpg_numero = 1, fpt_codigo = 1, fpg_status = true, fpg_exibePdv = true });
            objCtx.tbFormaPagamento.Add(new tbFormaPagamento { fpg_descricao = "CARTAO DEBITO", fpg_numero = 2, fpt_codigo = 5, fpg_status = true, fpg_exibePdv = true });
            objCtx.tbFormaPagamento.Add(new tbFormaPagamento { fpg_descricao = "CARTAO CREDITO", fpg_numero = 3, fpt_codigo = 6, fpg_status = true, fpg_exibePdv = true });
            objCtx.tbFormaPagamento.Add(new tbFormaPagamento { fpg_descricao = "CONVENIO", fpg_numero = 4, fpt_codigo = 7, fpg_status = true, fpg_exibePdv = true });
            objCtx.SaveChanges();
