...
namespace BSFoodFramework.DataAccess.Config
{
    public class tbPedidoConfig : EntityTypeConfiguration<tbPedido>
    {
        public tbPedidoConfig()
        {
            ...
            this.Property(e => e.ped_formaPagamentoTipo).HasColumnName("ped_formaPagamentoTipo");
            this.Property(e => e.ped_formaPagamentoDescricao).HasColumnName("ped_formaPagamentoDescricao").HasMaxLength(100);
