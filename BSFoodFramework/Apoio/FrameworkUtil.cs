...
namespace BSFoodFramework.Apoio
{
    ...
    public enum enFormaPagamentoTipo { Dinheiro = 1, ChequeVista = 2, ChequePrazo = 3, Boleto = 4, CartaoDebito = 5, CartaoCredito = 6, Convenio = 7 }
    ...
    public static class FrameworkUtil
    {
        ...
        /// Senha do banco
        /// </summary>
        public static string strSenhaBanco { get { return "sapwd"; } }
