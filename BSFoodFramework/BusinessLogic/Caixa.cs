...
namespace BSFoodFramework.BusinessLogic
{
    public class Caixa : ICaixa, IDisposable
    {
        ...
        //            {
        //                objCaixa.cai_dataAbertura = DateTime.Now;
        //                objCaixa.fun_codigo = FrameworkUtil.objConfigStorage.objFuncionario.fun_codigo;
        ...
        public Retorno RetornaCaixaFechamento(int intCodigo)
        {
            ...
            try
            {
                ...
                if (objCaixa != null)
                {
                    ...
                    //                                   where crec.olct_codigo == 16 && cai.cai_codigo == intCodigoCaixa && crec.emp_codigo == FrameworkUtil.objConfigStorage.emp_codigo
                    ...
                    //                                                       &&
                    //                                                       sup.emp_codigo == FrameworkUtil.objConfigStorage.emp_codigo
                    //                                                       &&
                    ...
                    //            objFechamento.Encerrantes = this.objCtx.spEncerrantesFechamentoCaixa(objCaixa.cai_dataAbertura, dtAgora, intCodigoCaixa, FrameworkUtil.objConfigStorage.objEmpresa.emp_codigo).ToList();
